    ...
    public class GameViewSizeHelper
    {
        ...
        public static void ChangeGameViewSize(GameViewSizeGroupType groupType, GameViewSize gameViewSize)
        {
            ...
            if (index != -1)
            {
                ...
                var selectedSizeIndexProp = Types.gameView.GetProperty("selectedSizeIndex",
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
                selectedSizeIndexProp.SetValue(gameView, index, null);

                /*PropertyInfo selectedSizeIndex = Types.gameView.GetProperty("selectedSizeIndex",
        ...
        private static bool GameViewSize_Equals(GameViewSize a, object b)
        {
            ...
            GameViewSizeType b_sizeType = (GameViewSizeType)Enum.Parse(typeof(GameViewSizeType),
                GetGameSizeProperty(b, "sizeType").ToString());
        ...
        private static GameViewSize Convert(object instance)
        {
            ...
            GameViewSizeType type = (GameViewSizeType)Enum.Parse(typeof(GameViewSizeType),
                GetGameSizeProperty(instance, "sizeType").ToString());
